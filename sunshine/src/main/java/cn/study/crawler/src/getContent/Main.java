package cn.study.crawler.src.getContent;
...
import cn.study.crawler.src.thread.AddBookUrlThread;
	...
	public static void GetAll(String urlFirst) throws Exception {
		...
		if (pageTotalString != null) {
			...
			for (int i = 1; i <= pageTotal; i++) {
				//小说的网址
				String url = "www.bookbaow.com/TXT/list1_"+i+".html";
				//加入线程池并发处理
...
//		String url = "www.bookbao8.com/BookList-c_0-t_2-o_1.html";
		String url = "www.bookbaow.com/TXT/list1_1.html";
		GetAll(url);
